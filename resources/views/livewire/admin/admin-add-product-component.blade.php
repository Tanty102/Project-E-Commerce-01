                                ...
                                <form wire:submit.prevent="addProduct">
                                    ...
                                    <div class="mb-3 mt-3">
                                        ...
                                        <textarea class="form-control" placeholder="Enter Short Description"
                                            wire:model='short_description' name="short_description">
                                        </textarea>
                                    ...
                                    <div class="mb-3 mt-3">
                                        <label for="stock_status" class="form-label">Stock
                                            Status</label>
                                    ...
                                    <div class="mb-3 mt-3">
                                        ...
                                        <select class="form-control" name="category_id" wire:model='category_id' id="">
